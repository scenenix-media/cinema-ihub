        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8">
            ...
            <p className="text-zinc-400 text-sm mb-6">
              Start generating cinematic videos with AI
            </p>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white text-black py-3 rounded-sm text-sm font-medium hover:bg-zinc-100 transition-colors flex items-center justify-center gap-3 mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
            >
